...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>Menus-Grilli - Amazing & Delicious Food</title>
    ...
    <article>
      ...
      <section class="section menu" aria-label="menu-label" id="menu">
        <div class="container">
          ...
          <h2 class="headline-1 section-title text-center">Delicious Snacks</h2>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/sm1.jpg" width="100" height="100" loading="lazy" alt="Samosa"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Samosa</a>
                    </h3>

                    <span class="badge label-1" >Special</span>

                    <span class="span title-2"><p>&#8377;50</p></span>
                  </div>

                  <p class="card-text label-1" >
                    Crispy deep fried samosas filled with boiled potatos and peas, onion, spices and hurbs and surved with two types of chutney.
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/sm2.jpg" width="100" height="100" loading="lazy" alt="Panjabi Thali"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Raj Kachori</a>
                    </h3>

                    <span class="span title-2"><p>&#8377;100</p></span>
                  </div>

                  <p class="card-text label-1">
                    crispy deep fried kachori filled with potatoes, moong dal, curd, spices and chutneys and topped with cilantro, sev, pomegranate
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/sm3.jpg" width="100" height="100" loading="lazy" alt="Sandwich Dhokla"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Sandwich Dhokla</a>
                    </h3>

                    <span class="span title-2"><p>&#8377;80</p></span>
                  </div>

                  <p class="card-text label-1">
                    Two layers of rice flor dhokla and a layer of green chutney and topped with curry leavs coriander tadka.
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/sm4.jpg" width="100" height="100" loading="lazy" alt="Palak Khandvi"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Palak Khandvi</a>
                    </h3>

                    <span class="badge label-1">New</span>

                    <span class="span title-2"><p>&#8377;120</p></span>
                  </div>

                  <p class="card-text label-1">
                    A treditional namkin khandvi with the flavor of spinach topped with pomogrenet , coconut and tadka.
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/sm5.jpg" width="100" height="100" loading="lazy" alt="Pani Puri"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2"><p>&#8377;40</p></span>
                  </div>

                  <p class="card-text label-1">
                    Fried rava puri and stuffing of mashed potato , chna, spices and topped with onion , coriander and pomogranate. 
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/sm6.jpg" width="100" height="100" loading="lazy" alt="Veg. Masaala Meggi"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Veg. Masaala Meggi</a>
                    </h3>
                  ...
                  <p class="card-text label-1">
                    Meggi with boiled vegitables like carrot, onion,capsicum, red chilli ,hurbs and spices.
                  </p>
          ...
          <p class="menu-text text-center">
            During winter daily from <span class="span">10:00 am</span> to <span class="span">11:00 pm</span>
          </p>

          <a href="Online-order.jsp" class="btn btn-primary">
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-banner">
          <img src="./assets/images/Spd.jpg" width="940" height="900" loading="lazy" alt="special dish"
            class="img-cover">
        </div>
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <h2 class="headline-1 section-title">Grilli Special </h2>

            <p class="section-text">
              "Come with family & feel the joy of mouthwatering food"<br>
              "Share your happiness with the sweetness of traditional sweet with the flavor of seasonal mango"
            </p>

            <div class="wrapper">
              <del class="del body-3"><del><p>&#8377;1000</p></del>
              </del>

              <span class="span body-1"><p>&#8377;500</p></span>
            </div>
      ...
      <section class="section menu" aria-label="menu-label" id="menu">
        <div class="container">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/m1.jpg" width="100" height="100" loading="lazy" alt="Gujarati Thali"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Gujarati Thali</a>
                    </h3>

                    <span class="badge label-1">Special</span>

                    <span class="span title-2"><p>&#8377;200</p></span>
                  </div>

                  <p class="card-text label-1">
                    Puri, two types of shabji, chatpta dahi, papd, samosa, kachori, sweets, dhokla, rice, dal.
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/m2.jpg" width="100" height="100" loading="lazy" alt="Panjabi Thali"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Panjabi Thali</a>
                    </h3>
                  ...
                  <p class="card-text label-1">
                    jeera rice, lachha paratha, dal makhani, shahi paneer.
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/mm3.jpg" width="100" height="100" loading="lazy" alt="Tortila"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Tortila</a>
                    </h3>

                    <span class="span title-2"><p>&#8377;150</p></span>
                  </div>

                  <p class="card-text label-1">
                    Tortila with fresh veggies
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/m41.jpg" width="100" height="100" loading="lazy" alt="Undhiyu Puri"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Undhiyu Puri</a>
                    </h3>
                  ...
                  <p class="card-text label-1">
                    Seasonal and traditional dish with various vegitables and sprouts with puri.
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/m5.jpg" width="100" height="100" loading="lazy" alt="Masala Dosa"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Masala Dosa</a>
                    </h3>
                  ...
                  <p class="card-text label-1">
                    Masala dosa with special dal and coconut chutny.
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/mm6.jpg" width="100" height="100" loading="lazy" alt="Orio Shake"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">Chilly Paneer Gravy</a>
                    </h3>
                  ...
                  <p class="card-text label-1">
                    Chilly,Paneer,onion,veggies,catch-ups.
                  </p>
          ...
          <p class="menu-text text-center">
             <span class="span">Make it a Meal</span>
          </p>
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-banner">
          <img src="./assets/images/spd1.jpg" width="940" height="900" loading="lazy" alt="special dish"
            class="img-cover">
        </div>
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <div class="wrapper">
              <del class="del body-3"><del><p>&#8377;1000</p></del></del>
      ...
      <section class="section menu" aria-label="menu-label" id="menu">
        <div class="container">
          ...
          <h2 class="headline-1 section-title text-center">Drinks</h2>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/md1.jpg" width="100" height="100" loading="lazy" alt="Gujarati Thali"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">BLOODY MARY</a>
                    </h3>

                    <span class="badge label-1">Special</span>

                    <span class="span title-2"><p>&#8377;140</p></span>
                  </div>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/md2.jpg" width="100" height="100" loading="lazy" alt="Panjabi Thali"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/md3.jpg" width="100" height="100" loading="lazy" alt="Vada Pav"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">SEA BREEZE </a>
                    </h3>
                  ...
                  <p class="card-text label-1">
                    Vada pav with masala tea and fried chilli.
                  </p>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/md4.jpg" width="100" height="100" loading="lazy" alt="Undhiyu Puri"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">COOLBERG</a>
                    </h3>

                    <span class="badge label-1">New</span>

                    <span class="span title-2"><p>&#8377;90</p></span>
                  </div>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/md5.jpg" width="100" height="100" loading="lazy" alt="Masala Dosa"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">MINT JULEP</a>
                    </h3>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/md6.jpg" width="100" height="100" loading="lazy" alt="Orio Shake"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="#" class="card-title">MAI TAI</a>
                    </h3>
                  ...
                  <p class="card-text label-1">
                    Cold orio shake with orio buscit and dark chocolet
                  </p>
          ...
          <p class="menu-text text-center">
            <span class="span">Good sip for good moments.</span>
          </p>

          <a href="Online-order.jsp" class="btn btn-primary">
            <span class="text text-1">Order Now</Nav></span>
